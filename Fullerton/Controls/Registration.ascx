...
<fieldset>
    <div class="form-group text-aline-left">
        ...
        <asp:TextBox runat="server" MaxLength="100" ID="txtUserName" ClientIDMode="Static" class="form-control"></asp:TextBox>
        <label id="txtUserNameError" class="red-text"></label>
    </div>
    <div class="form-group text-aline-left">
