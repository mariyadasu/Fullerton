<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadPresentation.aspx.cs" Inherits="Fullerton.DashBoard.Pages.TC.UploadPresentation" MasterPageFile="~/DashBoard/DashboardMaster.Master" %>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><i class="fa fa-th-list"></i>Upload Presentation</li>
                        </ol>
                    </div>
                </div>
                <!-- page start-->
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#btnSave").on("click", function () {
                ...
                if (txtNameOfIdea == "") {
                    $("#lblMessage")[0].innerText = "Please Enter Name Of Presentation";
                    return false;
                }
                if (fileConceptFile == "") {
